    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DerivedRecipe", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DerivedRecipe_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PullRecipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PullRecipes_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeLibraries", x => new { x.IdLibrary, x.IdRecipe });
                    table.ForeignKey(
                        name: "FK_RecipeLibraries_Libraries_IdLibrary",
                        column: x => x.IdLibrary,
                        principalTable: "Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeLibraries_Recipes_IdRecipe",
                        column: x => x.IdRecipe,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CookedWiths_IdRecipe",
                table: "CookedWiths",
                column: "IdRecipe");

            migrationBuilder.CreateIndex(
                name: "IX_DerivedRecipe_RecipeId",
                table: "DerivedRecipe",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_DerivedTags_IdDerivedRecipe",
                table: "DerivedTags",
                column: "IdDerivedRecipe");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MadeWiths_IdRecipe",
                table: "MadeWiths",
                column: "IdRecipe");

            migrationBuilder.CreateIndex(
                name: "IX_PullRecipes_RecipeId",
                table: "PullRecipes",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_RecipeId",
                table: "Questions",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeLibraries_IdRecipe",
                table: "RecipeLibraries",
                column: "IdRecipe");
